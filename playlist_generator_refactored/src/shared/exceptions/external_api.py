...
class MetadataEnrichmentError(ExternalAPIError):
    """Raised when metadata enrichment operations fail."""
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(message, api_name="MetadataEnrichment", **kwargs)
