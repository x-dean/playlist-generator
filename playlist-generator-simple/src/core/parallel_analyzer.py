...
class ParallelAnalyzer:
    ...
    def _get_analysis_config(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            log_universal('DEBUG', 'Parallel', f"UNIVERSAL memory optimization enabled: {analysis_config['MEMORY_OPTIMIZATION_ENABLED']}")
            log_universal('DEBUG', 'Parallel', f"UNIVERSAL memory optimization forced: {analysis_config['MEMORY_OPTIMIZATION_FORCE_ALL_CATEGORIES']}")
            ...
            log_universal('WARNING', 'Parallel', f"Using fallback config with UNIVERSAL memory optimization for {file_path}")
